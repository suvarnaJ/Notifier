...
public class ConnectingToDB {
    ...
    public List<Map<String, Object>> Execute(String sqlStr) throws SQLException {
        Connection developmentConnection = DriverManager.getConnection("jdbc:sqlserver://115.110.90.100:1433;databaseName=prjml;integratedSecurity=false;trustServerCertificate=true;","prjaiml","Tataetr@1424");
